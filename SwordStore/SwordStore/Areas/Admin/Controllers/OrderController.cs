...
namespace SwordStore.Areas.Admin.Controllers
{
    [Area("Admin")]
    [Authorize]
    public class OrderController : Controller
    {
        ...
        public IActionResult Onaylanan()
        {
            ...
            {
                orderHeadersList=_db.OrderHeaders.Where(i => i.ApplicationUserId ==claim.Value && i.OrderStatus==Diger.Durum_Onaylandı).Include(i => i.ApplicationUser);
            }
            return View(orderHeadersList);
        }
